...
|--------------|----------------------------|-----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|--------------|
| 1            | Functional: Sensor Reading | Check that the DHT11 sensor reads temperature and humidity accurately.                            | Run the data collection script from the local pi                                     | Temperature and humidity readings match the reference devices within ±2°C and ±5% RH.                                      | B            |
